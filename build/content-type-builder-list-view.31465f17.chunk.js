"use strict";(self.webpackChunkmarikarma_api_v_2=self.webpackChunkmarikarma_api_v_2||[]).push([[5905],{3500:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>rt});var e=n(67294),C=n(90731),m=n(96987),B=n(12473),H=n(34726),f=n(16607),l=n(62853),M=n(83598),w=n(18226),D=n(2382),X=n(97695),V=n(27361),r=n.n(V),g=n(18721),T=n.n(g),b=n(18446),x=n.n(b),j=n(11700),z=n.n(j),P=n(86896),J=n(16550),G=n(5923),fe=n(3547),ge=n(29299),_=n(69398),Z=n(10574),ke=n(38454),Be=n(45697),o=n.n(Be),K=n(27523),he=n(47558),v=n(90635),$=n(1565);const ye=$.default.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`,Ne=(0,$.default)(f.x)`
  ...
  position: relative;
  left: -0.25rem;
`,Ce=({children:t,icon:a,color:s,...i})=>e.createElement(Ne,{paddingBottom:4,paddingTop:4,as:"button",type:"button",...i},e.createElement(m.k,null,e.createElement(ze,{color:s,"aria-hidden":!0,background:`${s}200`},a),e.createElement(f.x,{paddingLeft:3},e.createElement(Z.Z,{variant:"pi",fontWeight:"bold",textColor:`${s}600`},t))));Ce.propTypes={color:o().string.isRequired,children:o().string.isRequired,icon:o().node.isRequired};const Qe=Ce,Ve=(0,$.default)(f.x)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,M=(0,C.default)(m.x)`
  ...
  width: 100%;
  border: none;
`,w=({children:D,icon:X,...V})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(B.i,{}),(0,e.jsx)(M,{as:"button",background:"primary100",padding:5,...V,children:(0,e.jsxs)(H.k,{children:[(0,e.jsx)(l,{"aria-hidden":!0,background:"primary200",children:X}),(0,e.jsx)(m.x,{paddingLeft:3,children:(0,e.jsx)(f.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:D})})]})})]})}}]);
